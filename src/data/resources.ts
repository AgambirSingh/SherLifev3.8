import { BookOpen, Calendar, HeartPulse, Users, Library, GraduationCap, Printer, CalendarDays, ListChecks} from 'lucide-react';
...
export const RESOURCES = [
  {
    ...
    icon: GraduationCap,
    link: 'https://sheridanworks.sheridancollege.ca/home.htm'
    }
  ];
